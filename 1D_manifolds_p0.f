...
C       Set the starting parameter values
        ...
        PAR(25)= 0             ! (Un)stable eigenvector x
        PAR(26)= 0               ! (Un)stable eigenvector y
        PAR(27)= 1                 ! (Un)stable eigenvector z
C        PAR(16) = (1+g1*z)**(-1)
       ENDIF
C     
C
...
C
       ...
       V31 = PAR(27)
C
       FB(1)=U0(1)-(PAR(14)*V11)
       FB(2)=U0(2)-(PAR(14)*V21)
       FB(3)=U0(3)-(PAR(14)*V31)
C
C
C
      RETURN
