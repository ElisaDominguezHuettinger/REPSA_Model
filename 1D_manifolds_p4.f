...
C        PAR(25)= 0.985504             ! Unstable eigenvector x
C        PAR(26)= -0.167583               ! Unstable eigenvector y
C        PAR(27)= -0.0264126                 ! Unstable eigenvector z
C        PAR(25)= 0.0             ! Unstable eigenvector x
C        PAR(26)= -0.987               ! Unstable eigenvector y
C        PAR(27)= 0.160722                 ! Unstable eigenvector z
         PAR(25)= 0.0             ! stable eigenvector x
         PAR(26)= 0.997484               ! stable eigenvector y
         PAR(27)= 0.070887                 ! stable eigenvector z
C        PAR(16) = (1+g1*z)**(-1)
       ENDIF
C     Singularity coordinates:
        a = 0
        b = 40.967264912339765
        c = 5.932735087660235
C
        V11 = PAR(25)
        V21 = PAR(26)
...
C
       ...
       V31 = PAR(27)
C
       FB(1)=U1(1)-(a + PAR(14)*V11)
       FB(2)=U1(2)-(b + PAR(14)*V21)
       FB(3)=U1(3)-(c + PAR(14)*V31)
C
C
C
      RETURN
