C----------------------------------------------------------------------
C----------------------------------------------------------------------
C   smf : Stable manifold of saddle point
C----------------------------------------------------------------------
C----------------------------------------------------------------------
C       Translation table:
C
...
C
C
        U(1) = a+eps*(cos(2*PI*PAR(15))*vsx!/P1!PAR(14)*cos(2*PI*PAR(15))*vsx/P1
     1       + sin(2*PI*PAR(15))*vssx)!/P2)
        U(2) = b+eps*(cos(2*PI*PAR(15))*vsy!/P1 ! PAR(14)*cos(2*PI*PAR(15))*vsy/P1
     1       + sin(2*PI*PAR(15))*vssy)!/P2)
        U(3) = c+eps*(cos(2*PI*PAR(15))*vsz!/P1 !PAR(14)*cos(2*PI*PAR(15))*vsz/P1
     1       + sin(2*PI*PAR(15))*vssz)!/P2)
C
      RETURN
      END
C
